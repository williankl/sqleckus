...
sealed class SQLecusException(val msg: String): Throwable(msg){
    object QueryWithoutEnoughTableStatements: SQLecusException("InnerJoin query must have at least two tables to work")
